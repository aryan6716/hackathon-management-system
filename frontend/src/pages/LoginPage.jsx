...
export default function LoginPage() {
  ...
  return (
    <div className="fixed inset-0 w-screen h-screen flex overflow-hidden">
      ...
      {/* LEFT PANEL */}
      <div className="hidden md:flex w-1/2 h-full relative flex-col justify-center px-16 lg:px-24 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/80 text-lg max-w-md">
            Join the ultimate hub for building exceptional projects.
          </p>
        </div>
      </div>

      {/* RIGHT PANEL */}
      <div className="w-full md:w-1/2 h-full bg-[#020617] flex items-center justify-center px-6 md:px-16">
