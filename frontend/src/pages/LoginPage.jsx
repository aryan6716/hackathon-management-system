...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      login(token, user)
      showToast('Welcome back to HackerPulse!', 'success')
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-4 overflow-hidden bg-slate-950">
      ...
      <FadeIn>
        ...
        >
          {/* Card Decoration */}
          <div className="absolute -top-20 -left-20 w-40 h-40 bg-indigo-500/10 blur-[80px] rounded-full pointer-events-none" />
          <div className="absolute -bottom-20 -right-20 w-40 h-40 bg-purple-500/10 blur-[80px] rounded-full pointer-events-none" />
              ...
              <form onSubmit={handleLogin} className="space-y-5">
                ...
                <StaggerItem className="space-y-1">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <Link to="#" className="text-xs font-bold text-indigo-400 hover:text-indigo-300 transition-colors">Forgot?</Link>
                  </div>
              ...
              <StaggerItem>
                <div className="relative py-4">
                  ...
                  <div className="relative flex justify-center text-[10px] uppercase font-bold tracking-[0.2em]">
                    <span className="bg-[#0f172a]/0 px-4 text-slate-500 backdrop-blur-sm">Or continue with</span>
                  </div>
                </div>
