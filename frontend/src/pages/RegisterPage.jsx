...
export default function RegisterPage() {
  ...
  return (
    <div onMouseMove={handleMouseMove} className="min-h-[100dvh] flex items-center justify-center bg-[#0B0F1A] text-white px-4 py-12 relative overflow-hidden md:px-0">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10 bg-[#0B0F1A] bg-[linear-gradient(45deg,#0B0F1A,#1a0b2e,#0a192f)] bg-[length:400%_400%] animate-gradient">
        <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-brand-violet/20 rounded-full blur-[120px] mix-blend-screen animate-blob" />
        <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-brand-blue/20 rounded-full blur-[120px] mix-blend-screen animate-blob animation-delay-200" />
        <div className="absolute top-[40%] right-[60%] w-[30%] h-[30%] bg-brand-accent/20 rounded-full blur-[120px] mix-blend-screen animate-blob animation-delay-400" />
      </div>
      ...
      >
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 ring-1 ring-white/10 p-8 sm:p-10 rounded-[24px] shadow-[0_24px_48px_rgba(0,0,0,0.5)] hover:scale-[1.02] hover:shadow-[0_32px_64px_rgba(0,0,0,0.6)] transition-all duration-500 relative z-10">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-4xl font-display font-900 tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-white to-white/70 mb-3">Create Account</h2>
            <p className="text-base text-slate-300 font-medium tracking-wide">Join HackathonHub today</p>
          </div>
          ...
          >
            ...
            {/* Button */}
            <motion.div variants={itemVars}>
              <Button type="submit" loading={loading} className="w-full py-3.5 mt-2 !rounded-xl active:scale-[0.98]">
